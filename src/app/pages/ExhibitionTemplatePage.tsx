...
export function ExhibitionTemplatePage() {
  return (
    <div>
      ...
      <section className="bg-primary text-white px-6 py-10">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg opacity-90 mb-10">
            Add a 3D walkthrough of any available spaces here. Alternatively, a gallery view of images can also be placed.
          </p>
          <div className="bg-primary/80 border border-white/20 w-full overflow-hidden rounded-md aspect-[16/9] flex items-center justify-center">
            <img
              src={PLACEHOLDER_IMAGE}
              alt="Placeholder for Matterport walkthrough"
